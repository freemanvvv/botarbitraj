...
- На этаже 0 обязательно есть прихожая; на каждом этаже выше — холл или
  коридор (лестничная площадка), даже если заказчик его не упомянул:
  через него ведут двери в комнаты этажа
